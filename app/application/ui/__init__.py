...
ui_bp.add_url_rule(
    "/discussion/moderation/<topic>/settings", view_func=views.moderation_topic_settings, methods=[GET, POST]
)
ui_bp.add_url_rule(
...
ui_bp.add_url_rule("/settings/user/email", view_func=views.change_email, methods=[POST])
